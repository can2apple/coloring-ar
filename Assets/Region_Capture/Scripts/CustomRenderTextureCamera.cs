...
public class CustomRenderTextureCamera : MonoBehaviour
{
    [Space(20)]
    ...
    public Camera ARCamera_Camera;
    public Camera Render_Texture_Camera;
    public GameObject Film_Plane;
    public GameObject DebugGUITexture;
    public RenderTexture CameraOutputTexture;
    public Material Film_Textured;
